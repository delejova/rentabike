<?php
// source: C:\xampp\htdocs\TP\app/templates/Place/cbc.latte

use Latte\Runtime as LR;

class Template7870f266a3 extends Latte\Runtime\Template
{
	public $blocks = [
...
<?php
	...
	function prepare()
	{
		...
		if (isset($this->params['bike'])) trigger_error('Variable $bike overwritten in foreach on line 54');
...
?>
 <h3> CBC Cassovar Business Center II, Žriedlová 13, 040 01, Košice </h3> 
 <br>   
...
<p>
    <b><?php echo LR\Filters::escapeHtmlText($bike->id) /* line 57 */ ?> </b>
    <b><?php echo LR\Filters::escapeHtmlText($bike->bike_name) /* line 58 */ ?> </b>
    <br> Bike mumber : <?php echo LR\Filters::escapeHtmlText($bike->bike_number) /* line 59 */ ?>

    <br> Stav : <strong><?php echo LR\Filters::escapeHtmlText($bike->status) /* line 60 */ ?></strong>
    <br><img src="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 61 */ ?>/images/<?php
			echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($bike->photo_filename)) /* line 61 */ ?>" class="img-responsive img-circle" height="100" width="100">
