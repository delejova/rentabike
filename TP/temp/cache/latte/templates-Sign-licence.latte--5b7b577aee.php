<?php
// source: C:\xampp\htdocs\TP\app/templates/Sign/licence.latte

use Latte\Runtime as LR;

class Template5b7b577aee extends Latte\Runtime\Template
{
	public $blocks = [
    ...
    <div class="container-fixed">
      ...
      <div class="navbar-persistent">
        ...
        <ul class="nav navbar-nav navbar-nav-icons navbar-right">
           ...
           <li><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Sign:register")) ?>">Back</a></li>
        </ul>
      </div>
    </div>
  </nav>
...
<object data="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 40 */ ?>/licence/licencia.pdf" type="application/pdf" width="100%" height="1000px">
<a href="<?php echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 41 */ ?>/licence/licencia.pdf">licencia.pdf</a>
</object>     
