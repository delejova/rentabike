<?php
// source: C:\wamp\www\TP\app/templates/Sign/login.latte

use Latte\Runtime as LR;

class Template66b2a992c4 extends Latte\Runtime\Template
{
	public $blocks = [
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Forgot:default")) ?>">I forget my password</a></li>
        </ul>
    </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
