<?php
// source: C:\wamp\www\TP\app/templates/@layout.latte

use Latte\Runtime as LR;

class Template26541a38f5 extends Latte\Runtime\Template
{
	public $blocks = [
...
?>
    ...
    <body>
        <!-- TOTO JE DOCASNE - BUDE TO V NAVBARE -->
        <div style="text-align: right">
        <b><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Profil:")) ?>">Home page - profil</a></b>
        <br><b><a href="<?php echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link(":Sign:logout")) ?>">Log Out</a></b>
        </div>
