<?php
// source: C:\wamp\www\projektT_verzia_1\projektT\app/config/config.neon 
// source: C:\wamp\www\projektT_verzia_1\projektT\app/config/config.local.neon 

class Container_81cdbf7347 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Presenters\PlacePresenter' => [1 => ['application.3']],
			'App\Presenters\RentPresenter' => [1 => ['application.4']],
		...
		'services' => [
			...
			'application.3' => 'App\Presenters\PlacePresenter',
			'application.4' => 'App\Presenters\RentPresenter',
	...
	{
		parent::__construct([
			'appDir' => 'C:\wamp\www\projektT_verzia_1\projektT\app',
			'wwwDir' => 'C:\wamp\www\projektT_verzia_1\projektT\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\wamp\www\projektT_verzia_1\projektT\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\wamp\www\projektT_verzia_1\projektT\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wamp\www\projektT_verzia_1\projektT\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp\www\projektT_verzia_1\projektT\app/../temp/cache',
	...
	{
		return new Container_81cdbf7347_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_81cdbf7347_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_81cdbf7347 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\wamp\www\projektT_verzia_1\projektT\app/../temp/cache/latte');
