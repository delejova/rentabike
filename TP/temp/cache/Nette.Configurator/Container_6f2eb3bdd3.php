<?php
// source: C:\xampp\htdocs\projektT\app/config/config.neon 
// source: C:\xampp\htdocs\projektT\app/config/config.local.neon 

class Container_6f2eb3bdd3 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Model\BaseModel' => [
				1 => ['26_App_Model_PlaceModel', '28_App_Model_RoleModel', 'authenticator'],
			],
			'App\Model\PlaceModel' => [1 => ['26_App_Model_PlaceModel']],
			'App\Model\RegisterModel' => [1 => ['27_App_Model_RegisterModel']],
			...
			'App\Presenters\PlacePresenter' => [1 => ['application.4']],
			'App\Presenters\RegisterPresenter' => [1 => ['application.5']],
			'App\Presenters\RolePresenter' => [1 => ['application.6']],
			'App\Presenters\SignPresenter' => [1 => ['application.7']],
			'App\Presenters\UserPresenter' => [1 => ['application.8']],
		...
		'services' => [
			...
			'27_App_Model_RegisterModel' => 'App\Model\RegisterModel',
			...
			'application.4' => 'App\Presenters\PlacePresenter',
			'application.5' => 'App\Presenters\RegisterPresenter',
			'application.6' => 'App\Presenters\RolePresenter',
			'application.7' => 'App\Presenters\SignPresenter',
			'application.8' => 'App\Presenters\UserPresenter',
	...
	{
		parent::__construct([
			'appDir' => 'C:\xampp\htdocs\projektT\app',
			'wwwDir' => 'C:\xampp\htdocs\projektT\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\projektT\app/../temp',
		]);
	}
	 ...
	 */
	public function createService__27_App_Model_RegisterModel()
	{
		$service = new App\Model\RegisterModel;
		return $service;
	}
	...
	{
		$service = new App\Presenters\RegisterPresenter($this->getService('27_App_Model_RegisterModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	/**
	 * @return App\Presenters\RolePresenter
	 */
	public function createServiceApplication__6()
	{
		$service = new App\Presenters\RolePresenter($this->getService('28_App_Model_RoleModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new App\Presenters\UserPresenter($this->getService('authenticator'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\projektT\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\projektT\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\projektT\app/../temp/cache',
	...
	{
		return new Container_6f2eb3bdd3_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_6f2eb3bdd3_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_6f2eb3bdd3 $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\xampp\htdocs\projektT\app/../temp/cache/latte');
