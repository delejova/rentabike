<?php
// source: C:\wamp\www\TP\app/config/config.neon 
// source: C:\wamp\www\TP\app/config/config.local.neon 

class Container_4981d5222d extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		parent::__construct([
			'appDir' => 'C:\wamp\www\TP\app',
			'wwwDir' => 'C:\wamp\www\TP\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\wamp\www\TP\app/../temp',
		]);
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\wamp\www\TP\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\wamp\www\TP\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\wamp\www\TP\app/../temp/cache',
	...
	{
		return new Container_4981d5222d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_4981d5222d_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_4981d5222d $container)
	{
	...
	public function create()
	{
		...
		$service->setTempDirectory('C:\wamp\www\TP\app/../temp/cache/latte');
