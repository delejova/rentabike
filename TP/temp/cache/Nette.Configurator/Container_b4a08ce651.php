...
class Container_b4a08ce651 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
	...
	{
		$service = new App\Presenters\PlacePresenter($this->getService('29_App_Model_PlaceModel'));
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			$this->getService('routing.router'), $this->getService('http.request'),
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
	...
	{
		return new Container_b4a08ce651_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
...
final class Container_b4a08ce651_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
	private $container;


	public function __construct(Container_b4a08ce651 $container)
	{
